...
global $wpdb;
$freCheIn = $_POST['freCheIn'];
$userIdChe = $_POST['userIdChe'];
update_user_meta( $userIdChe, 'freeCheckIn', $freCheIn );

foreach( $wpdb->get_results("SELECT * FROM `im_devToken` where `user_id` = $userIdChe") as $key => $row) {
...
global $wpdb;
$title = "Hinger Pass";
$description = "Reward! Admin has provided you ".$freCheIn." Free checkings as per your activities in our Application";
	//FCM api URL
